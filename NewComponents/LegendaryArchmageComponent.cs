...
namespace AddedFeats.NewComponents {
    ...
    /// </summary>
    [TypeId("fd1765008292469cb8d26ea1e0d23ec0")]
    public class LegendaryArchmageComponent : AbilityApplyEffect, IAbilityRestriction, IAbilityRequiredParameters {
            ...
            static void Postfix(AbilityData __instance, ref IEnumerable<AbilityData> __result) {
                ...
                if (__instance.SpellSlot != null && __instance.Spellbook != null) {
                    foreach (Ability ability in __instance.Caster.Abilities) {
                        var QuickStudy = ability.Blueprint.GetComponent<LegendaryArchmageComponent>();
        ...
        internal static class AbilityData_IsAvailableInSpellbook_QuickStudy_Patch {
            static void Postfix(AbilityData __instance, ref bool __result) {
                if (__instance.Blueprint.GetComponent<LegendaryArchmageComponent>()) {
                    __result = true;
                }
            }
        }
