...
namespace AddedFeats.NewComponents
{
    ...
    public class SpiritComponent : UnitFactComponentDelegate, IInitiatorRulebookHandler<RuleCanApplyBuff>, IRulebookHandler<RuleCanApplyBuff>, ISubscriber, IInitiatorRulebookSubscriber, IResourcesHolder
    {
        ...
        {
            Logger.Log("I am in on event about to trigger because I can be.");
            ...
            {
                Logger.Log("I am in on event about to trigger because I can be and in my archmage buff if");
